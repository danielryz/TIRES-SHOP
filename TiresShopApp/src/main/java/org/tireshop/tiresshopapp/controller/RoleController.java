...
import org.tireshop.tiresshopapp.dto.request.UpdateRoleRequest;
...
public class RoleController {
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Lista ról zwrócona pomyślnie", content = @Content(
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Rola znaleziona",content = @Content(
                    mediaType = "application/json",
                    schema = @Schema(implementation = Role.class))),
            @ApiResponse(responseCode = "400", description = "Brak uprawnień",content = @Content(
                    mediaType = "application/json",
            ...
            @ApiResponse(responseCode = "404", description = "Rola nie istnieje", content = @Content(
    ...
    @ApiResponses(value = {
            @ApiResponse(responseCode = "200", description = "Rola dodana"),
            @ApiResponse(responseCode = "400", description = "Brak uprawnień",content = @Content(
                    mediaType = "application/json",
                    examples = @ExampleObject( value = "{\"error\": \"Acces Denied\"}")
            )),
