...
public class CartItemController {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "Zwrócono koszyk"), @ApiResponse(responseCode = "404", description = "Nie znaleziono koszyka")})
    @GetMapping
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "Zwrócono dane produktu"), @ApiResponse(responseCode = "404", description = "Nie znaleziono produktu")})
    @GetMapping("/summary")
    @PreAuthorize("hasRole('USER')")
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "Dodano produkt"), @ApiResponse(responseCode = "404", description = "Nie znaleziono produktu")})
    @PostMapping
    @PreAuthorize("hasRole('USER')")
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "Zmieniono ilość produktu"), @ApiResponse(responseCode = "404", description = "Nie znaleziono produktu")})
    @PatchMapping("/{id}")
    @PreAuthorize("hasRole('USER')")
    public ResponseEntity<CartItemResponse> updateCartItem(@PathVariable Long id, @RequestBody UpdateCartItemRequest request) {
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "Produkt usunięty z koszyka"), @ApiResponse(responseCode = "404", description = "Nie znaleziono produktu")})
    @DeleteMapping("/{id}")
    @PreAuthorize("hasRole('USER')")
    ...
    @ApiResponses({@ApiResponse(responseCode = "200", description = "Wyczszczono koszyk"), @ApiResponse(responseCode = "404", description = "Błąd")})
    @DeleteMapping()
    @PreAuthorize("hasRole('USER')")
