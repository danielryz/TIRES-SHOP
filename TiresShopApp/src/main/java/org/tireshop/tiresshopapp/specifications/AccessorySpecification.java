...
public class AccessorySpecification {
  ...
  public static Specification<Accessory> hasAccessoryType(AccessoryType accessoryType) {
    return (root, query, criteriaBuilder) -> accessoryType == null ? null
        : criteriaBuilder.equal(criteriaBuilder.lower(root.get("accessoryType")),
            accessoryType.toString().toLowerCase());
  }
