...
public class OrderSpecifications {
    ...
    public static Specification<Order> hasUserId(Long userId) {
        return (root,query,criteriaBuilder) ->
                userId == null ? null : criteriaBuilder.equal(root.join("user_id").get("id"), userId);
    }

    public static Specification<Order> hasStatus(OrderStatus status) {
        return (root,query,criteriaBuilder) ->
                status == null ? null : criteriaBuilder.equal(criteriaBuilder.lower(root.get("status")), status.toString().toLowerCase());
    }

    public static Specification<Order> createdAtGreaterThan(LocalDateTime createdAtGreaterThan) {
        return (root,query,criteriaBuilder) ->
                createdAtGreaterThan == null ? null : criteriaBuilder.greaterThanOrEqualTo(root.get("created_at"), createdAtGreaterThan);
    }

    public static Specification<Order> createdAtLessThan(LocalDateTime createdAtLessThan) {
        return (root,query,criteriaBuilder) ->
                createdAtLessThan == null ? null : criteriaBuilder.lessThanOrEqualTo(root.get("created_at"), createdAtLessThan);
    }
    ...
    public static Specification<Order> paidAtGreaterThan(LocalDateTime paidAtGreaterThan) {
        return (root,query,criteriaBuilder) ->
                paidAtGreaterThan == null ? null : criteriaBuilder.greaterThanOrEqualTo(root.get("paid_at"), paidAtGreaterThan);
    }

    public static Specification<Order> paidAtLessThan(LocalDateTime paidAtLessThan) {
        return (root,query,criteriaBuilder) ->
                paidAtLessThan == null ? null : criteriaBuilder.lessThan(root.get("paid_at"), paidAtLessThan);
    }
}
