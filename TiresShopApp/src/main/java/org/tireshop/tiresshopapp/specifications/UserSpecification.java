...
public class UserSpecification {
    ...
    public static Specification<User> hasPhoneNumberContaining(String phoneNumber) {
        return (root,query,criteriaBuilder) ->
                phoneNumber == null ? null : criteriaBuilder.like(criteriaBuilder.lower(root.get("phoneNumber")), "%" + phoneNumber.toLowerCase() + "%");
    }

    public static Specification<User> hasRole(String role) {
        return (root,query,criteriaBuilder) ->
                role == null ? null : criteriaBuilder.like(criteriaBuilder.lower(root.get("role")), "%" + role.toLowerCase() + "%");
    }
}
