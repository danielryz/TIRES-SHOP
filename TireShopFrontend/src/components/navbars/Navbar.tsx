...
import { getTokenPayload, isAdmin } from '../../utils/authUtils';
// @ts-ignore
import logo from '../../assets/logo.png';
import './Navbar.css';
import {FaShoppingCart, FaUserPlus, FaSignInAlt, FaSearch, FaPhoneAlt, FaUserCircle} from 'react-icons/fa';
    ...
    return (
        <nav className="navbar">
            ...
            <form className="navbar-search">
                ...
                <button type="submit" className="search-submit-btn">Szukaj</button>
            </form>
