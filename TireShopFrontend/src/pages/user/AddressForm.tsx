...
function AddressForm({ existingAddress, onSave, onCancel, showAlert }: Props) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      showAlert(msg || "Address has been created successfully.", "success");
      onSave();
    } catch (err: any) {
  ...
  return (
    <form className="address-form" onSubmit={handleSubmit}>
      ...
      <div className="form-actions">
        <button type="submit">
          {existingAddress ? "Zapisz zmiany" : "Dodaj adres"}
        </button>
