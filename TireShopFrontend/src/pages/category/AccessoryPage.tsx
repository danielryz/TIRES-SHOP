                ...
                const accessoryWithImages = await Promise.all(
                    accessoryData.map(async (accessory) => {
                        try {
                            ...
                            console.error('Failed to load image for accessory:', accessory.id);
                    ...
                    <div key={accessory.id} className="accessory-card">
                        <div className="accessory-image">
                            {accessory.imageUrls && accessory.imageUrls.length > 0 ? (
                                <img src={accessory.imageUrls[0]} alt={accessory.name} className="accessory-img" />
                            ) : (
                        ...
                        <div className="accessory-info">
                            ...
                            <p><strong>Rodzaj:</strong> {accessory.accessoryType}</p>
                            <p><strong>Stan:</strong> {accessory.stock} szt.</p>
                        ...
                        <div className="accessory-buy">
                            <div className="buy-box">
                                ...
                                {accessory.stock > 0 ? (
                                    <button className="add-to-cart-btn" onClick={() => handleAddToCart(accessory.id)}>
                                        Dodaj do koszyka
                                    </button>
                                ) : (
