                    ...
                    <div key={tire.id} className="tire-card">
                        <div className="tire-image">
                            {tire.imageUrls && tire.imageUrls.length > 0 ? (
                                <img src={tire.imageUrls[0]} alt={tire.name} className="tire-img" />
                            ) : (
                        ...
                        <div className="tire-info">
                            <h2>{tire.name}</h2>
                            <p><strong>Sezon:</strong> {tire.season}</p>
                            <p><strong>Rozmiar:</strong> {tire.size}</p>
                            <p><strong>Stan:</strong> {tire.stock} szt.</p>
                        ...
                        <div className="tire-buy">
                            <div className="buy-box">
                                ...
                                {tire.stock > 0 ? (
                                    <button className="add-to-cart-btn" onClick={() => handleAddToCart(tire.id)}>
                                        Dodaj do koszyka
                                    </button>
                                ) : (
